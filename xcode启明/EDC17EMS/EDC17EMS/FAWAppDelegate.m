...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.businessLayer = [[FAWBusinessLayer alloc] init];
    
    self.window.rootViewController = [[FAWLoginViewController alloc] initWithNibName:@"FAWLoginViewController" bundle:nil];
