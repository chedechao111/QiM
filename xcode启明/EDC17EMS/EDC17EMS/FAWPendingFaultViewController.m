//
//  FAWPendingFaultViewController.m
//  EDC17EMS
//
//  Created by Zephyr on 15-7-13.
...
@interface FAWPendingFaultViewController ()

@end

@implementation FAWPendingFaultViewController
...
- (void)viewDidLoad
{
    ...
    self.navigationItem.title = @"当前故障";
...
- (void)asyncWorkStarted
{
    ...
    error = [self.businessLayer readCurrentDTCToArray:&tempFaultsArray];
